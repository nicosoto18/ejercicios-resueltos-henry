...
function promedioResultadosTest(resultadosTest) {
   ...
   for(i=0; i<resultadosTest.length; i++){
      ...
      var promedioFinal = sumaTotal / cantidadNotas;
...
function empiezaConNueve(num) {
   ...
   // Tu código:
   var numeroSeparado = num.toString().split('');
